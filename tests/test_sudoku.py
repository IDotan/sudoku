...
def test_find_square():
    ...
    for i in range(9):
        ...
        for j in range(9):
            temp.append(i + 1)
        assert sudoku.find_square(grid, squares[i][0], squares[i][1], 3) == temp
...
def test_check_no_duplicates_no_dup():
    ...
    assert sudoku.check_no_duplicates(grid, 3) is True
...
def test_check_no_duplicates_dup_row():
    ...
    assert sudoku.check_no_duplicates(grid, 3) is False
